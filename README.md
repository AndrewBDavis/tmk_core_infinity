...
This [tmk_core_infinity](https://github.com/AndrewBDavis/tmk_core_infinity) repo is outdated and is specifically for compiling TMK firmware for the Input Club Infinity keyboard. It includes CibiOS and CiboOS-Contrib versions that were found to work with Kairyu's TMK code. It is not recommended as a stand-alone replacement for [tmk_keyboard](https://github.com/tmk/tmk_keyboard).

It is also recommended that you use my [/keyboard/infinity_chibios/](https://github.com/AndrewBDavis/keyboard/tree/master/infinity_chibios) files and follow the instructions to compile the .bin file there.  
