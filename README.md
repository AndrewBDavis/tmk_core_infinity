...
It recommended though that you use my [/keyboard/infinity_chibios/](https://github.com/AndrewBDavis/keyboard/tree/master/infinity_chibios) files and follow the instructions to compile the .bin file there. This will save you from editing cconfig.h and the Makefile.
